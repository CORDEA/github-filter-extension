...
const startDate: HTMLInputElement = document.querySelector('#GitHubFilter-startDate')
const endDate: HTMLInputElement = document.querySelector('#GitHubFilter-endDate')
